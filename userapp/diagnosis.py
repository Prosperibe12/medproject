...
class PriaidDiagnosisClientDemo:
    ...
    def __init__(self):
        ...
        authUrl = settings.AUTHSERVICE_URL
        healthUrl = settings.HEALTHSERVICE_URL
        language = settings.LANGUAGE
        self._printRawOutput = settings.PRINTRAWOUTPUT

        self._diagnosisClient = apis.DiagnosisClient(username, password, authUrl, language, healthUrl)
    ...
    def _loadSublocationSymptoms(self, subLocId):
        symptoms = self._diagnosisClient.loadSublocationSymptoms(subLocId, apis.SelectorStatus.Man)
    ...
    def _loadDiagnosis(self, selectedSymptoms):
        ...
        diagnosis = self._diagnosisClient.loadDiagnosis(selectedSymptomsIds, apis.Gender.Male, 1988)
    ...
    def _loadSpecialisations(self, selectedSymptoms):
        ...
        specialisations = self._diagnosisClient.loadSpecialisations(selectedSymptomsIds, apis.Gender.Male, 1988)
    ...
    def _loadProposedSymptoms(self, selectedSymptoms):
        ...
        proposedSymptoms = self._diagnosisClient.loadProposedSymptoms(selectedSymptomsIds, apis.Gender.Male, 1988)
